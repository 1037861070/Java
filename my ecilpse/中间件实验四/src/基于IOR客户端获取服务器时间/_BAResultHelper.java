...
abstract public class _BAResultHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (基于IOR客户端获取服务器时间._BAResultHelper.id (), "BAResult", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    基于IOR客户端获取服务器时间._BAResult value = new 基于IOR客户端获取服务器时间._BAResult ();
