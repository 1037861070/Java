	 ...
	 <form action="addStudent" method = "post"> 
		...
		<div class = "form-group">
			<div class = "form-label clearfix right">
				...
				<input type = "text" class = "c-559ae2" style ="width:200px;" name = "sex">
			</div>
			<p class="err">&nbsp;</p>
		</div>
		<div class = "form-group">
			<div class = "form-label clearfix right">
				...
				<input type = "text" class = "c-559ae2" style ="width:200px;" name = "birth" placeholder = "格式：YYYY-MM-DD">
			</div>
			<p class="err">&nbsp;</p>
		</div>
		<div class = "form-group">
		...
		<div class = "form-group">
			<div class = "form-label clearfix right">
				...
				<input type = "text" class = "c-559ae2" style ="width:200px;" name = "entrance" placeholder = "格式：YYYY-MM-DD">
			</div>
			<p class="err">&nbsp;</p>
		</div>
		<div class = "form-group">
...
<div class = "login loginDialog" id = "updateDialog" style = "display:none;">
	<div class = "main">	
		...
		<div class = "form-group">
			<div class = "form-label clearfix right">
				<label class = "fl" style = "font-size:15px;">学号</label>
				<input type = "text" class = "c-559ae2" style ="width:200px;" name = "studentID1" id = "studentID">
			</div>
			<p class="err">&nbsp;</p>
		</div>
		<div class = "form-group">
		...
		<div class = "form-group">
			<div class = "form-label clearfix right">
				<label class = "fl" style = "font-size:15px;">出生日期</label>
				<input type = "text" class = "c-559ae2" style ="width:200px;" name = "birth1" id = "birth">
			</div>
			<p class="err">&nbsp;</p>
		</div>
		<div class = "form-group">
		...
		<div class = "form-group">
			<div class = "form-label clearfix right">
				<label class = "fl" style = "font-size:15px;">入学日期</label>
				<input type = "text" class = "c-559ae2" style ="width:200px;" name = "entrance1" id = "entrance">
			</div>
			<p class="err">&nbsp;</p>
		</div>
		<div class = "form-group">
