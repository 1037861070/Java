...
<div id="homeWrap">
    <div class="help bs1">
        ...
        <div class="mleft fl">
            ...
            <h3><span class="mleft-li12">个人中心</span></h3>
        ...
        <div class="mright mt12 fr">
            <div class="tt"><h3>常用联系人信息</h3></div>
            <input type="hidden" id="ctlguid" value="f2bbad4d456947e88b68aab909cf7497"/>
                ...
                <div class="padding10">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>
                                <input name="item.name" type="text" class="inputU" value="" id="itemname">
                        ...
                        <tr>
                            <td align="right">
                                证件类型 <span class="red">*</span>
                            </td>
                            <td>
                                <select class="select27x110" id="cardtype" tabindex="6">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="inputU" value="" onblur="checkIdcard()" id="idcard">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="inputU" value="" id="phone" size="30" onblur="checkphone()"
                                       tabindex="10">
                        ...
                        <tr>
                            <td align="right"></td>
                            <td>
                                <a class="sub_02" onclick="makesubst()">保存</a>
                            </td>
                        </tr>
                    </table>
                </div>
