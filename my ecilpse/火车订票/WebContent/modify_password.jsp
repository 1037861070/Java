    ...
    <div class="help bs1">
        ...
        <div class="mright mt12 fr" id="pswdiv">
            ...
            <div class="login_page login_Pwd" style="width: 80%;">
                <ul>
                    <li><label><em class="red">*</em>原密码：</label><input
                            id="oldpsw" name="userpwd" type="password" class="inputU"/></li>
                    <li><label><em class="red">*</em>新密码：</label><input
                            id="newpsw" name="userpwd" type="password" class="inputU"/> <span>密码长度为6-20位，建议使用混合密码
						</span></li>
                    <li><label><em class="red">*</em>重复密码：</label><input
                            id="enterpsw" name="userpwd" type="password" class="inputU"/> <span>请再次输入相同的密码
						</span></li>
                    <li><a class="sub_02" href="javascript:checkInfo();">提交</a></li>
