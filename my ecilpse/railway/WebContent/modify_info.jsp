...
function checkInfo() {
	...
	document.form2.action = "Modify_info";
...
<body>
	...
	<div id="header">
		<div class="logo">
			<br> <br> <br> <br> <img
				style="float: left; width: 52px; height: 52px;"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td><input name="user.realname" type="text" class="inputU"
								value="<%=name%>" onblur="checkName()"  id="realname"> <span id="nameErr"
						...
						<tr>
							...
							<td><input name="user.idNumber" type="text" class="inputU"
								value="<%=idNumber%> " onblur="checkIdcard()" id="idcard">
						...
						<tr>
							...
							<td><input type="text" name="user.address" class="inputU"
								value="<%=telNumber%> " id="phone" size="30"
								onblur="checkphone()" tabindex="10"> <span
								id="mobileErr" style="color: red;"></span></td>
						</tr>

						<tr>
							<td align="right"></td>
							<td><a class="sub_02"  href="javascript:void(0);"
							  onclick="checkInfo();">提交</a> 
