<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
         <%@page import="domain.UserContact"%>
...
<head>
    ...
    <% 
    UserContact user_contact=(UserContact)request.getSession().getAttribute("UserContact");
    int userId=user_contact.getUserId();
    String name=user_contact.getName();
    String idType=user_contact.getIdType();
    String idNumber=user_contact.getIdNumber();
    String telNumber=user_contact.getTelNumber();
    User user = (User) request.getSession().getAttribute("User");
    String idNumber1 = user.getIdNumber();
    String idType1 = user.getIdType();
    String name1 = user.getName();
    String password1 = user.getPassword();
    int role1 = user.getRole();
    int userId1 = user.getUserId();
    String userName1 = user.getUserName();
    String telNumber1 = user.getTelNumber();
...
<div id="header">
 ...
 <font size="4" face="楷体" color="blue">
        <strong id="hello"></strong><strong class="red" id="islogin"><a
            href="personal_centre.jsp"><font color="red"> <%=name %>></font></a><a
