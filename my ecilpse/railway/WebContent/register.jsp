...
function checkpsw(){
	 var password = document.getElementById("userpwd").value;
     var conform = document.getElementById("userpwd2").value;
...
function checkInfo() {
	...
	var idcard2 = document.getElementById("idcard").value;
	var true_name = document.getElementById("true_name").value;
	 var oldpsw = document.getElementById("userpwd").value;
     var newpsw = document.getElementById("userpwd2").value;
 
     if (newpsw != oldpsw) {
         alert("两次新密码输入不一至,请检查密码.");
         return;
     }
				...
				<form id="form1" name="form1" method="post">
					...
					<ul class="regdiv">
						...
						<li><label><em class="red">*</em>密码：</label><input
							id="userpwd" name="userpwd" type="password" class="inputU"  onblur ="checkpsw1()"
							/><span>密码长度为6-20位，建议使用混合密码</span></li>
						<li><label><em class="red">*</em>重复密码：</label><input
							id="userpwd2" name="userpwd2" type="password" class="inputU" onblur ="checkpsw()"
							 /><span>请再次输入相同的密码</span></li>
						<li><label><em class="red">*</em>姓名：</label><input
							id="true_name" name="true_name" type="text" class="inputU" onblur ="checkName1()"/>
							<span>请输入真实姓名</span></li>
